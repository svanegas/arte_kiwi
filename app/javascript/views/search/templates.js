    ...
    <div class='col-12 col-md-6 col-lg-4 card my-1 kiwi-bg-white border-0'>
      <div class='row m-2 m-md-3 no-gutters'>
        <div class='col-6 card-height'>
          <a id="${product.gtm_id}" href='/productos/${product.label}/${product.slug}'>
        ...
        <div class='col-12 pt-2'>
          <a id="${product.gtm_id}" href='/productos/${product.label}/${product.slug}' class='d-flex align-items-center justify-content-center kiwi-btn kiwi-btn--sm kiwi-btn--red font-family-work-sans color-white card-btn'>
